...
describe("calculateReplayState", () => {
  ...
  it("clamps progress outside the replay interval", () => {
    expect(calculateReplayState(-1, 2, 5.25).tSec).toBe(-300);
